...
\textit{nový výměnný formát (NVF)}, často označovaný zkratkou \zk{VFK}. Data v novém formátu jsou poskytována ve dvou
časových režimech:
...
Pokud je verze knihovny GDAL [\ref{subsec:gdal_vfk}] GDAL 2.1 a nižší, po načtení \zk{VFK} souboru nedojde k sestavení geometrie jednotlivých prvků automaticky. Uživatel si proto musí sestavení
