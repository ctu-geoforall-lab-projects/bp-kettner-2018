...
soubor ve formátu \zk{VFK}, čímž vznikne \zk{SQL} databáze s načtenými
daty. \zk{VFK} soubor již není dále využíván, knihovna místo toho
přistupuje k vytvořené \zk{SQL} databázi. Následně je zkontrolována
...
Zkomprimovaná testovací data ve formátu \zk{VFK} jsou stažena pro
...
nastane chyba. To se může stát není-li připojen \zk{VFK} souboru nebo
databáze.
...
argumenty(v našem případě pouze název \zk{VFK} souboru) předané z
